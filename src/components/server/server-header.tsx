  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="focus:outline-none" asChild>
        <button className="w-full bg-secondary text-lg font-semibold px-3 flex items-center h-16 border-b border-border hover:bg-secondary-foreground/5 transition cursor-pointer">
          {server.name}
      ...
      <DropdownMenuContent className="w-56 text-xs font-medium text-foreground space-y-[2px]">
        {isModerator && (
          <DropdownMenuItem
            ...
            className="text-accent px-3 py-2 text-sm cursor-pointer"
          >
            Invite People
